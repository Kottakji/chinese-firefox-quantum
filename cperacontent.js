...
var ppcContent = {
    ...
    getContentType: function (tDoc) {
        ...
        for (var i in m) {
            if (typeof m[i].httpEquiv !== "undefined") {
...
//			this.copyToClip();
    ...
    onKeyUp: function (ev) {
        if (ppcContent.keysDown[ev.keyCode]) ppcContent.keysDown[ev.keyCode] = 0;
    },
    ...
    processEntry: function (e) {
        ...
        chrome.runtime.sendMessage({"type": "makehtml", "entry": e}, ppcContent.processHtml);
    },
    ...
    highlightMatch: function (doc, rp, ro, matchLen, selEndList, tdata) {
        if (typeof selEndList === 'undefined' || selEndList.length === 0) {
            return;
        }
    ...
    showTitle: function (tdata) {
        chrome.runtime.sendMessage({"type": "translate", "title": tdata.title},
